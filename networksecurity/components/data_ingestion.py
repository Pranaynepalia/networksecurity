...
class DataIngestion:
    ...
    def export_collection_as_dataframe(self):
        ...
        try:
            ...
            # Connection parameters - same as in your NetworkDataExtract class
            host = "cluster0.epl8o.mongodb.net"
            user = "pranaynepalia015"
            password = "Admin123"
            
            # Construct proper MongoDB URI
            uri = f"mongodb+srv://{user}:{password}@{host}/?retryWrites=true&w=majority"
            
            # Connect with TLS CA certificate
            ...
            logging.error(f"Error connecting to MongoDB: {type(e).__name__}: {str(e)}")
            raise NetworkSecurityException(e, sys)
    ...
    def initiate_data_ingestion(self):
        try:
            ...
            logging.error(f"Error in data ingestion: {type(e).__name__}: {str(e)}")
            raise NetworkSecurityException(e, sys)